.PHONY: dev dev-stop dev-db dev-test-db dev-index-db dev-index-test-db dev-server dev-index dev-web generate check test test-integration test-index-integration build
